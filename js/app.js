...
function showMineResult(won){
  ...
  if(won){
    emoji.textContent = '🎉';
    title.textContent = 'ربحت ي حبيبي!';
    msg.textContent = 'زي ما كسبت اللعبة دي، أنا كمان اخترتك وأنا متأكدة إنك أحسن اختيار في حياتي. كل يوم بحبك أكتر من اللي قبله، وأنت اللي بتملالي دنيتي فرح وحلاوة 💕 يارب أعيش معاك لآخر يوم في عمرنا';
  } else {
    emoji.textContent = '💔';
    title.textContent = 'خسرت ي حبيبي!';
    msg.textContent = 'مفيش مشكلة! اللعبة خسرتها بس قلبي معاك دايماً. أنا عارفة إنك بتحبني أكتر من كده بكتير، وأنا كمان بحبك أوي ي حبيبي ❤️';
  }
